...
def test_one():
    ...
    assert more_than_half_num_partition(lst) == 1

def test_none():
    lst = []
    assert more_than_half_num(lst) == None
    assert more_than_half_num_with_dict(lst) == None
    assert more_than_half_num_partition(lst) == None
